  ...
  const orgs = [
    {
      ...
      body: 'Tamil Nadu’s apex skills development centre dedicated  to the automotive sector, established under the Government of Tamil Nadu to bridge the skill gap in India’s rapidly growing automotive industry. A state-of-the-art facility creating a steady pipeline of trained professionals for OEMs, Tier-1 suppliers, and the broader automotive ecosystem.',
